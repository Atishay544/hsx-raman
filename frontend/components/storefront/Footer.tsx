    ...
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6 mt-16">
      <div className="max-w-350 mx-auto px-4 sm:px-6 lg:px-10 grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-sm leading-relaxed">Fresh food, hot meals & groceries delivered to your door in 10 minutes.</p>
      ...
      <div className="border-t border-gray-800 pt-6 max-w-350 mx-auto px-4 sm:px-6 lg:px-10 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 text-sm">
          ...
          <span>Vivek Saxena</span>
          <a href="tel:+4407818923405" className="hover:text-white transition">+44 07818 923405</a>
          <a href="mailto:riders@highstreetexpress.com" className="hover:text-white transition">riders@highstreetexpress.com</a>
        </div>
      </div>
    </footer>
  )
