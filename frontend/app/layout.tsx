...
export const metadata: Metadata = {
  ...
  title: {
    default: "HighStreetExpress — 10-Minute Fashion Delivery UK",
  ...
  description: "UK's fastest fashion & lifestyle delivery. Order in seconds, delivered to your door in 10 minutes. Shop premium fashion, accessories & more with HighStreetExpress.",
  keywords: [
    "10 minute delivery UK", "quick fashion delivery", "fast delivery fashion",
    "HighStreetExpress", "HSX", "express delivery UK", "instant fashion delivery",
    "premium fashion UK", "lifestyle delivery", "10 min delivery",
    "quick commerce UK", "ultra-fast delivery", "fashion accessories UK",
    "same day delivery fashion", "rapid delivery UK",
  ],
  ...
  openGraph: {
    ...
    title: "HighStreetExpress — 10-Minute Fashion Delivery UK",
    description: "Order premium fashion & lifestyle products and get them delivered in 10 minutes. Free delivery above £20.",
    images: [
      {
        url: `/opengraph-image`,
        width: 1200,
        height: 630,
        alt: "HighStreetExpress — 10-Minute Fashion Delivery UK",
      },
    ],
  },
  twitter: {
    ...
    title: "HighStreetExpress — 10-Minute Fashion Delivery UK",
    description: "Order premium fashion & lifestyle products and get them delivered in 10 minutes.",
  ...
  "@graph": [
    {
      ...
      description: "UK's fastest fashion & lifestyle delivery. Order in seconds, delivered to your door in 10 minutes. Free delivery above £20. 30-day returns.",
