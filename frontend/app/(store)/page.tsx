      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Yes. Free delivery on all orders above £20. Orders below £20 have a flat fee of £2.99.' },
          },
          {
            '@type': 'Question',
            name: 'What payment methods are accepted?',
            acceptedAnswer: { '@type': 'Answer', text: 'We accept all major credit and debit cards (Visa, Mastercard), processed securely.' },
          },
          {
            '@type': 'Question',
            name: 'What is the return policy?',
            acceptedAnswer: { '@type': 'Answer', text: '30-day hassle-free returns. Contact riders@highstreetexpress.com with your order ID.' },
          },
        ],
      },
    ],
